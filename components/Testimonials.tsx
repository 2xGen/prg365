...
const offerings = [
  ...
  },
  {
    ...
    description:
      "Trip planning support and curated itineraries so guests make the most of their time in Prague.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          What We <span className="text-prg-red">Offer</span> Travelers
        </h2>
        <p className="text-slate-600 text-center max-w-2xl mx-auto mb-14">
          Prg365 is designed to become the most trusted source for booking tours in Prague.
        </p>
